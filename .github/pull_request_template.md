## 📌 Purpose
<!-- Brief description of what this PR accomplishes and why it is needed. -->
...
<!-- Describe automated tests and validation performed. -->
- [ ] Unit tests added/updated (`pytest`)
- [ ] Linter & formatter clean (`ruff check` & `ruff format`)
