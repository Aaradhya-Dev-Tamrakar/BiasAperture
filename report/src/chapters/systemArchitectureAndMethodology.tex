...
\begin{table}[htbp]
    ...
    \begin{tabular}{p{3.2cm}p{5cm}p{4.3cm}}
        ...
        Explainability Layer & Attribute a detected disparity to input features (FR-005) & Demographic-dummy surrogate attribution (\gls{shap} deferred) \\
