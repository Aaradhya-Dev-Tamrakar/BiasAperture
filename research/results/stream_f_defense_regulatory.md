...
- SHAP → Measure 2.9 (explainability) directly, and supports Measure 2.11 indirectly (distinguishing a real disparity from a Stanley-et-al.-style proxy artifact is itself a documentation-quality requirement).
