...
- test_image_column_alias_resolution_other_aliases
...
- Weekly Project Report (WK1)
- Weekly Project Report (WK2)
- Fairlearn
- bias_aperture
- EU AI Act
- Abstract
...
- `HTML Report Generator` --references--> `NIST AI RMF`  [EXTRACTED]
  src/bias_aperture/report/generator.py → AGENT.md
- `BiasAperture High-Level Architecture Diagram` --references--> `BiasAperture Platform`  [INFERRED]
...
- **Claim Verification & Correction Workflow** — research_research_tracks_task_007_gate0_setup_prompt, research_research_tracks_task_008_gate1_setup_prompt, research_research_tracks_task_010_gate2_setup_prompt, research_research_tracks_task_011_gate3_setup_prompt [EXTRACTED 1.00]
- **Dataset Scale & Scope Reconciliation** — fairface_dataset, utkface_dataset, research_results_discrepancy_ledger, research_results_discrepancy_fix_ledger [EXTRACTED 1.00]
- **Discrepancy Verification Flow** — research_results_discrepancy_verification_report_summary, research_results_discrepancy_verification_report_cluster_a, research_results_discrepancy_verification_report_cluster_b, research_results_discrepancy_verification_report_cluster_c [EXTRACTED 1.00]
...
Cohesion: 0.04
Nodes (44): Aaradhya Dev Tamrakar, Session Walkthrough: Full Codebase Audit, 1. Executive Summary & Objectives, 2. Audit Findings & Resolution Matrix, 3.1 Native AIF360 Backend (`src/bias_aperture/fairness/backends.py`), 3.2 Additive Shapley Surrogate Explainability (`src/bias_aperture/explainability.py`), 3.3 CLI Integration (`src/bias_aperture/cli.py`), 3.4 Package & Dependency Alignment (`pyproject.toml`, `uv.lock`) (+36 more)

### Community 2 - "Phase-2 Research Synthesis"
Cohesion: 0.13
...
### Community 3 - "BiasAperture: Integration as Innovation"
Cohesion: 0.09
...
Cohesion: 0.07
Nodes (26): 1. Efficiency (Local Accuracy), 1. Executive Summary, 2.1 The Cooperative Game Theory Formulation, 2.2 The Four Axiomatic Pillars (Uniqueness Guarantee), 2. Symmetry (Equal Treatment), 2. Theoretical Foundations of SHAP, 3.1 Combinatorial Weights in Exact Shapley Formulation, 3.2 Regression Weights in KernelSHAP (+18 more)

### Community 10 - "BiasAperture — Research Sprint: Low-Level Technical Specification"
Cohesion: 0.08
...
### Community 15 - "predict_single_image"
Cohesion: 0.14
...
### Community 18 - "Data Exploration Report — FairFace & UTKFace"
Cohesion: 0.17
...
Cohesion: 0.17
Nodes (9): BiasAperture-AT (v11), 1. Verification Lifecycle, 2. Master Research Claim Register, 3. Invalidated Claims (Research Failures & Refutations), 4. Claim Verification Status Summary, Academic Audit Statement, BiasAperture — Research Claim Ledger, FairFace Dataset (+1 more)

### Community 22 - "01 - Architecture"
Cohesion: 0.14
...
### Community 29 - "track_A_dataset_scale_utkface.md"
Cohesion: 0.14
Nodes (8): Output format, Prompt (task spec), Setup (paste first, before the Prompt section below), Track A — Dataset Scale & UTKFace Claims, Output format, Prompt (task spec), Setup (paste first, before the Prompt section below), Track B — Explainability Method Claims (SHAP vs. Demographic-Dummy Surrogate)

### Community 30 - "Discrepancy Ledger — Independent Verification Report"
Cohesion: 0.20
...
### Community 39 - "3. Detailed Accomplishments & Technical Highlights"
Cohesion: 0.18
Nodes (11): 1. Executive Summary & Objectives, 2. Work Packages & Milestone Mapping, 3.1 20-Track Parallel Research Sprint & 3-Level Syntheses, 3.2 Dataset Profiling & Empirical Discoveries, 3.3 Native AIF360 Backend Harmonization (`src/bias_aperture/fairness/backends.py`), 3.4 Exact Additive Shapley Surrogate Explainability (`src/bias_aperture/explainability.py`), 3.5 Test Suite & Code Quality (55/55 Tests Passing), 3. Detailed Accomplishments & Technical Highlights (+3 more)

### Community 40 - "BiasAperture — Weekly Project Report (WK5)"
Cohesion: 0.18
Nodes (10): 1. Executive Summary, 2. Work Completed, 3. Commit History and Work Diff, 4. Current Milestone State, 5. Open Decisions and Next Actions, 6. Evidence References, BiasAperture — Weekly Project Report (WK5), Documentation Synchronization (+2 more)

### Community 41 - "BiasAperture — Presentation Discrepancy Notes"
Cohesion: 0.18
Nodes (10): 1. Dataset Scale — FairFace 108,501 vs. 97,698, 2. UTKFace Shown as Live Secondary Benchmark, 3. Orchestration Box — "CLI + YAML config", 4. Compliance Report Format — "HTML/PDF", 5. Article 10 Deadline — Stated as Current, 6. Core Four Metrics — Slide Numbering Error, 7. Minor Typo, 8. SHAP Explainability — No Surrogate Caveat (+2 more)

### Community 42 - "Stream C Synthesis — Fairness Engine (Tracks 09–14)"
Cohesion: 0.18
...
### Community 43 - "BiasAperture — Weekly Project Report (WK1)"
Cohesion: 0.18
...
### Community 44 - "BiasAperture — Weekly Project Report (WK3)"
Cohesion: 0.18
...
### Community 45 - "BiasAperture — Proposal Defense Preparation Guide"
Cohesion: 0.20
...
### Community 48 - "BiasAperture — Weekly Project Report (WK2)"
Cohesion: 0.20
...
### Community 58 - "Part 2: Literature Review, Theoretical Framework & Positioning [10 Marks]"
Cohesion: 0.14
Nodes (14): 1. Intersectional Auditing Framework (Crenshaw, 1989; Buolamwini & Gebru, 2018), 2.1 Research Questions & Analytical Decomposition, 2.2 Foundational Conceptual Frameworks, 2.3 Critical Analysis of the Literature (The 14 Pillars), 2.4 Official Literature Review Matrix (Walden / AIF Standard), 2.5 Comparative Landscape Analysis: 7-Tool Audit Matrix, 2.6 Academic & Engineering Positioning: The Novelty Defense, 2. Group Fairness Parity Criteria (Hardt et al., 2016; Barocas et al., 2019) (+6 more)

### Community 59 - "check_stale_claims.py"
Cohesion: 0.36
Nodes (7): check_text(), _line_number(), main(), _paragraphs_with_offset(), Split text into (start_offset, paragraph_text) pairs on blank lines., Return (line_number, rule_name, message) for each violation., Rule

### Community 60 - "3. Slide-by-Slide Script & Talking Points"
Cohesion: 0.29
...
Cohesion: 0.29
Nodes (7): Cluster A - Dataset Scale Verification, Cluster B - Explainability Verification, Cluster C - Architecture Verification, Cluster D - WP Completion Verification, Discrepancy Verification Report Summary, SHAP Explainability & Proxy Detection Synthesis, Surrogate Explainability Strategy

### Community 66 - "Stream B Synthesis — Report Generation (Tracks 05–08)"
Cohesion: 0.29
...
### Community 67 - "Stream D Synthesis — Explainability (Tracks 15–16)"
Cohesion: 0.29
...
### Community 68 - ".compute_cohort_profile"
Cohesion: 0.29
...
### Community 71 - "AGENT.md — Developer & AI Agent Guidelines"
Cohesion: 0.33
Nodes (5): 1. Non-Negotiable Project Constraints, 2. Directory Layout & Module Ownership, 3. Build & Test Commands, 4. Git & Branching Strategy, AGENT.md — Developer & AI Agent Guidelines

### Community 72 - "ANTIGRAVITY.md — Google Antigravity & Gemini Coding Guidelines"
Cohesion: 0.33
...
### Community 73 - "8. Mock Grilling Checklist"
Cohesion: 0.33
...
### Community 79 - "Stream E Synthesis — Architecture & Testing (Tracks 17–18)"
Cohesion: 0.33
...
### Community 80 - "00 - Overview and MVP Scope"
Cohesion: 0.33
...
### Community 87 - "Stream F Synthesis — Defense & Regulatory (Tracks 19–20)"
Cohesion: 0.40
...
### Community 88 - "03 - Orchestrator"
Cohesion: 0.40
Nodes (4): 03 - Orchestrator, Failure behavior, Handoff contract, Run flow

### Community 89 - "04-intake-and-classification.md"
Cohesion: 0.40
Nodes (4): 04 - Intake and Audit Classification, Audit target, Supported intake, Validation modes

### Community 90 - "10 - Security and Governance"
Cohesion: 0.40
Nodes (4): 10 - Security and Governance, Data governance, Diagnostic boundary, Reproducibility and integrity

### Community 91 - "test_image_column_alias_resolution_other_aliases"
Cohesion: 0.67
Nodes (3): parametrize, Gap fix: only the 'file' alias was previously tested, but IMAGE_COL_ALIASES…, test_image_column_alias_resolution_other_aliases()

### Community 92 - "Data Directory Layout"
Cohesion: 0.50
Nodes (3): Data Directory Layout, Directory Structure, Sourcing the FairFace Benchmark (FR-001)

### Community 93 - "BiasAperture Literature Review"
Cohesion: 0.50
